...
#'
#' @description
#' A function which takes in the inputs and returns a tibble of the data
#'
#'
#' @param Arrivals The arrival time of the customers
#' @param ServiceTimes The service time of the customers
#' @param NumServers The number of customers served
#'
#' @return Returns the tibble of the data
#' @export
#'
#' @examples
#' data <- matrix(data = 1:20, nrow = 10, ncol = 2)
#' Multiserver(data[,1],data[,2])
